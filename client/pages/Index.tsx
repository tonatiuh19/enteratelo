      ...
      <section className="relative overflow-hidden">
        <div className="relative h-[70vh] lg:h-[80vh]">
              ...
              <div className="relative h-full">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-8 lg:p-16 text-white">
                  <div className="max-w-4xl">
                    ...
                    <div className="flex flex-col lg:flex-row lg:items-center lg:space-x-8 space-y-4 lg:space-y-0 mb-8">
          ...
          <Button
            variant="secondary"
            size="icon"
            className="absolute left-8 top-1/2 -translate-y-1/2 bg-white/20 hover:bg-white/30 text-white border-white/30 backdrop-blur-sm w-12 h-12"
            onClick={prevSlide}
          >
          ...
          <Button
            variant="secondary"
            size="icon"
            className="absolute right-8 top-1/2 -translate-y-1/2 bg-white/20 hover:bg-white/30 text-white border-white/30 backdrop-blur-sm w-12 h-12"
            onClick={nextSlide}
          >
          ...
          <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex space-x-3">
            {featuredArticles.map((_, index) => (
              <button
                key={index}
                className={cn(
                  "transition-all duration-300 rounded-full border border-white/50",
                  index === currentSlide
                    ? "bg-white w-12 h-3"
          ...
          <div className="xl:col-span-3 space-y-12">
            ...
            <section>
              <div className="flex items-center space-x-2 mb-6">
                ...
                <h2 className="text-2xl font-bold">Marcadores en Vivo</h2>
                <Badge
                  variant="secondary"
            ...
            <section>
              <div className="flex items-center space-x-2 mb-6">
                ...
                <h2 className="text-2xl font-bold">Actualizaciones en Vivo</h2>
              </div>
            ...
            <section>
              <div className="flex items-center space-x-2 mb-8">
                ...
                <h2 className="text-3xl font-bold">Selección del Editor</h2>
              </div>
            ...
            <section>
              <div className="flex items-center space-x-2 mb-8">
                ...
                <h2 className="text-3xl font-bold">Contenido en Video</h2>
              </div>
              ...
              <CardContent>
                {polls[0] && (
                  <div className="space-y-4">
                    <h4 className="font-medium text-sm">{polls[0].question}</h4>
